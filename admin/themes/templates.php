...
<head>
    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html"> EWU Onile Classroom </a>
        ...
        <div class="wrapper">
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/modstudent/index.php"><i class="menu-icon icon-bold"></i>Add Students </a></li>
         ...
         <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2020 MANNANOMI </b> All rights reserved.
            </div>
        </div>
